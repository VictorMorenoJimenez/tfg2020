...
@Injectable()
export class CommentsRepliesPartialUpdateFormService {
  form: FormGroup;
  defaultValue: any;
  ...
  constructor(
    ...
    this.form = new FormGroup({
      data: new FormGroup({
        ...
        text: new FormControl({value: undefined, disabled: false}, [Validators.minLength(1), Validators.required]),
        comment_data: new FormGroup({
          id: new FormControl({value: undefined, disabled: false}, []),
          text: new FormControl({value: undefined, disabled: false}, [Validators.minLength(1), Validators.required]),
          traveler_data: new FormGroup({
            id: new FormControl({value: undefined, disabled: false}, []),
          ...
          plan_data: new FormGroup({
            ...
            start_time: new FormControl({value: undefined, disabled: false}, [Validators.required]),
            price: new FormControl({value: undefined, disabled: false}, []),
            duration: new FormControl({value: undefined, disabled: false}, [Validators.maxLength(16)]),
            capacity: new FormControl({value: undefined, disabled: false}, [Validators.max(2147483647), Validators.min(-2147483648)]),
            traveler: new FormControl({value: undefined, disabled: false}, [Validators.required]),
            traveler_data: new FormGroup({
              id: new FormControl({value: undefined, disabled: false}, []),
              code: new FormControl({value: undefined, disabled: false}, [Validators.maxLength(32), Validators.minLength(1), Validators.required]),
              accepted_lopd: new FormControl({value: undefined, disabled: false}, []),
            ...
            destination: new FormControl({value: undefined, disabled: false}, [Validators.required]),
            destination_data: new FormGroup({
              id: new FormControl({value: undefined, disabled: false}, []),
              name: new FormControl({value: undefined, disabled: false}, [Validators.maxLength(256), Validators.minLength(1), Validators.required]),
              description: new FormControl({value: undefined, disabled: false}, [Validators.maxLength(256), Validators.minLength(1), Validators.required]),
              address: new FormGroup({
    ...
    this.cacheSub = {};
    this.cache = 'CommentsRepliesPartialUpdate';
  }

  submit(value: any = false): Observable<__model.Reply> {
    const cache = false;
    ...
    this.cacheSub[JSON.stringify(value) + cache] = new ReplaySubject<__model.Reply>(1);
  ...
  try(subject: ReplaySubject<__model.Reply>, value: any, cache_hit: boolean, cache: boolean, waitOnRetry = 1000, maxRetries = environment.apiRetries): void {
    const result = this.commentsService.repliesPartialUpdate(value);
    result.pipe(
      map(val => {
