...
\section{Solución adoptada}
	\begin{text}
		Con el fin de cumplir todos los objetivos definidos en la sección \nameref{ObjetivosPropuestos} se han elegido las siguientes tecnologías. Cabe destacar la influencia ejercida por la empresa para utilizar tecnologías ya existentes en la infraestructura actual como los firewall pfSense o el servicio de virtualización Proxmox. Sin embargo, son tecnologías con continuo desarrollo y muy aptas para desarrollar su papel dentro del cluster. \\
