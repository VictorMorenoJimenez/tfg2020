...
\begin{usecase}{Recrear infraestructura << CU.11 >>}
	...
	\addrow{Precondición}{El usuario administrador ha ejecutado correctamente << CU.0 >>, los ficheros hosts.yml con los nodos objetivo y asignado las variables necesaris enl os roles \textbf{hetzner} y \textbf{proxmox\_nodes}.}
	...
	\addmulrow{Secuencia principal (P)}{
		\item El administrador ejecuta \\ correctamente << CU.0 >>
		\item El administrador clona \\ el proyecto.
		\item El administrador configura \\ fichero \textbf{hosts.yml} 
		\item El administrador configura \\ variables 
		de role \textbf{hetzner}. 
		\item El administrador configura \\ variables 
