...
\section{Subobjetivos, requisitos funcionales e issues}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{RF 3.4}. El sistema permitirá la creación de un servicio de gestión de aplicaciones en el cluster.
	...
	\begin{text}
		...
		\begin{itemize}
			...
			\item \textbf{Milestone 5:} Cluster preparado para desplegar aplicaciones.
				\begin{itemize}
					\item \textbf{Issue 5.1}
					\item \textbf{Issue 5.2}
					\item \textbf{Issue 5.3}
					\item \textbf{Issue 5.4}
					\item \textbf{Issue 5.5}
				\end{itemize}
			\item \textbf{Milestone 6:} Despliegue automático de aplicaciones.
				\begin{itemize}
					\item \textbf{Issue 6.1}
					\item \textbf{Issue 6.2}
					\item \textbf{Issue 6.3}
					\item \textbf{Issue 6.4}
				\end{itemize}
		\end{itemize}
	\end{text}
